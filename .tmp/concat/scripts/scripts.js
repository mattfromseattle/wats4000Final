...
angular.module('wats4000FinalApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/saved.html',
    "<div class=\"jumbotron\"> <h4>Favorite Articles</h4> <ul class=\"saved-article-list\"> <li ng-repeat=\"article in storage.savedArticle\"> <span class=\"glyphicon glyphicon-heart\" aria-hidden=\"true\"></span> <a ng-href=\"{{article.id}}\" target=\"_blank\">{{article.name}}</a> </li> </ul> </div>"
  );
